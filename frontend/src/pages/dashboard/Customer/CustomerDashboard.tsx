    ...
    return (
      <div className="w-full max-w-[1080px] mx-auto px-[46px] py-6">
        <div className="flex flex-col items-center justify-center p-12 bg-background-card border border-dashed border-accent-red rounded-xl text-center">
          ...
          <button
            className="bg-accent-red text-text-primary border-none px-4 py-2 rounded-md font-medium cursor-pointer"
          ...
          <section>
            ...
            {isLoading ? (
              ...
              <div className="bg-background-card border border-dashed border-border rounded-xl p-10 text-center">
                ...
                <p className="text-text-secondary text-sm">{t('customerDashboard.noActiveShipments')}</p>
              </div>
            ) : (
              <div className="grid grid-cols-2 gap-4 max-md:grid-cols-1">
                    ...
                    >
                      ...
                      <div className="flex flex-col gap-1.5">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-[11px] font-semibold text-text-secondary">{progress}%</span>
                        </div>
          ...
          <section>
            ...
            {isLoading ? (
              ...
              <div className="bg-[rgba(19,186,186,0.05)] border border-dashed border-[rgba(98,255,255,0.15)] rounded-xl p-10 text-center">
                ...
                <p className="text-text-secondary text-sm">{t('customerDashboard.noPastShipments')}</p>
              </div>
            ) : (
                ...
                <table className="w-full border-collapse min-w-[560px]">
                  <thead className="bg-[rgba(19,186,186,0.1)]">
                    <tr>
                      ...
                      <th
                        className="text-left px-5 py-4 text-[11px] font-semibold text-[#62ffff] uppercase border-b border-[rgba(98,255,255,0.2)] cursor-pointer select-none hover:text-text-primary transition-colors"
                    ...
                    {pastShipments.map(shipment => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-5 py-3.5 text-sm border-b border-[rgba(98,255,255,0.1)] text-text-secondary">
